...
import {
  CarFront, CircleDollarSign, ClipboardList, LayoutDashboard, LogOut,
  Settings, Truck, Users, X,
} from 'lucide-react'
import Avatar from '../common/Avatar'
import { useLanguage } from '../../i18n/LanguageContext'

const icons = [LayoutDashboard, Truck, CircleDollarSign, ClipboardList, Users, Settings, CarFront]
...
export default function Sidebar({ page, setPage, open, setOpen }) {
  ...
  return <aside className={open ? 'sidebar sidebar--open' : 'sidebar'}>
    ...
    <nav>{t.nav.map((label, index) => {
      ...
      const active = (index === 0 && page === 'dashboard') || (index === 1 && page === 'drivers') || (index === 2 && page === 'finance') || (index === 3 && page === 'history') || (index === 5 && page === 'settings')
